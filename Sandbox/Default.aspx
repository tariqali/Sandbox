...
<body>
    ...
    <div class="MainContent">
        ...
        <div>
            <label>
                RegEx:</label>
            <input type="text" style="height: 20px; font-size: 16px; font-weight: bold; width: 600px;"
                id="RegEx" value="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" /></div>
        <div>
            <label>
                Text to check:</label>
        ...
        <label>
            Result:</label>
        <div class="results" id="resultText">
        </div>
        <hr />
        <h2>
            Ajax call</h2>
        ...
        <hr />
        <h2>
            Server-Side Reverse call</h2>
        <label>
            String to reverse</label>
        <input type="text" id="strReverse" runat="server" />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Reverse It" />
        <label>
            Results:</label><div class="results" id="reverseResult" runat="server">
            </div>
        </form>
        <hr />
        <h2>
            Client-Side Reverse call</h2>
        <label>
            String to reverse</label>
        <input type="text" id="localStrReverse" />
        <input type="button" onclick="ReverseString(document.getElementById('localStrReverse').value)"
            value="Reverse It" />
        <label>
            Results:</label><div class="results" id="localResults">
            </div>
    </div>
</body>
</html>
